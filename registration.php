...
<body>
    <header class="header-2">
        <nav class="container-2 header-nav-2">
          ...
          <div>
        <a href="sign-in.php" class="header-link" href="sign-in.php">Войти</a>
        <a href="registration.php" class="header-link" href="registration.php">Регистрация</a>
        </div> 
        </nav>
      </header>
      <main>
        ...
        <div class="Name">
          <input type="text" class="name" name="name" placeholder="Введите ваше имя" required></input>
        </div>
        <div class="Mail">
          <input type="email" class="mail" name="email" placeholder="Введите вашу почту" required></input>
        </div>
        <div class="Telefon">
          <input type="text" class="telefon" name="number" placeholder="Введите ваш номер телефона"></input>
        </div><br>
        <div class="Gender">
        ...
        <div class="Password">
          <input type="password" class="password" name="password" placeholder="Введите пароль" required></input>
        </div>
        <button type="submit" class="auto">Зарегистрироваться</button>
        <div class="text-down"><br>
          <p class="t-d">Вы уже зарегистрированы? <a class="sign-in-reg" href="sign-in.php">Войти</a></p>
        </div>
      </div>
        </form>
      </main>
